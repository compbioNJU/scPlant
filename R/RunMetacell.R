...
#' 
#' @importFrom metacell scdb_init scm_import_sce_to_mat scfigs_init mcell_plot_umis_per_cell mcell_mat_ignore_genes
#' @importFrom metacell mcell_mat_ignore_small_cells mcell_add_gene_stat mcell_gset_filter_varmean mcell_gset_filter_cov
#' @importFrom metacell mcell_plot_gstats mcell_add_cgraph_from_mat_bknn mcell_coclust_from_graph_resamp mcell_mc_from_coclust_balanced
#' @importFrom metacell mcell_plot_outlier_heatmap mcell_mc_split_filt mcell_gset_from_mc_markers mc_colorize_default
#' @importFrom metacell mcell_mc_plot_marks mcell_mc2d_force_knn mcell_mc2d_plot mcell_mc_hclust_confu mcell_mc_hierarchy mcell_mc_plot_hierarchy
#'
#' @export
#'
RunMetacell <- function(SeuratObj, species) {
  ...
  scdb_init("metacelldb/", force_reinit=T)
  ...
  mcell_coclust_from_graph_resamp(coc_id="test_coc500", 
                                  graph_id="test_graph",
                                  min_mc_size=20, 
                                  p_resamp=0.75, n_resamp=500)
  mcell_mc_from_coclust_balanced(coc_id="test_coc500", 
                                 mat_id= "test",
                                 mc_id= "test_mc", 
