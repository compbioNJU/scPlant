...
RunMonocle3 <- function(SeuratObj,
  ...
  if (save_plot) {
    ...
    pheatmap::pheatmap(agg_mat, cluster_rows=TRUE, cluster_cols=TRUE,
                       ...
                       fontsize=6, filename = './output/RunMonocle3/deg_clusters_module.pdf')
  }
  ...
  if (save_plot) {
    ...
    pheatmap::pheatmap(agg_mat, scale="column", clustering_method="ward.D2",
                       filename = './output/RunMonocle3/deg_pseudotime_module.pdf')
  }
  ...
  if (save_plot) {
    ...
    pdf('./output/RunMonocle3/plot_genes_by_group.pdf')
  ...
  #### save plots
  if (save_plot) {
    if (!dir.exists(paths = "./output/RunMonocle3")) {
      dir.create("./output/RunMonocle3", recursive = TRUE)
    }
    monocle3::save_monocle_objects(cds=cds, directory_path='./output/RunMonocle3/cds_objects')
    # visualization
    pdf('./output/RunMonocle3/graph.pdf')
    ...
    pdf('./output/RunMonocle3/pseudotime.pdf', width = 10, height = 8)
    monocle3::plot_cells(cds,
    ...
    pdf('./output/RunMonocle3/genes_expression.pdf')
    ...
    pdf('./output/RunMonocle3/plot_genes_in_pseudotime.pdf')
    ...
    pdf('./output/RunMonocle3/plots.pdf')
    monocle3::plot_cells(cds)
