...
We provided a true scRNA-seq data of Arabidopsis thaliana ([Zhang et al., 2019](https://www.sciencedirect.com/science/article/pii/S1674205219301339)) as example data, download [here](https://biobigdata.nju.edu.cn/scPlantDB/SeuratObj.rds)
...
```{bash, eval = FALSE}
# We have provided a script used to produce the input files for MINI-EX:
wget https://biobigdata.nju.edu.cn/scPlantDB/scPlantData.zip
unzip scPlantData.zip
