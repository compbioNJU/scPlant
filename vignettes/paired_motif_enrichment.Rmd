...
The required databases and scripts to perform Paired Motif Enrichment analysis can be downloaded [here](https://biobigdata.nju.edu.cn/scPlantDB/scPlantData.zip).
...
Take a true scRNA-seq data of Arabidopsis thaliana ([Zhang et al., 2019](https://www.sciencedirect.com/science/article/pii/S1674205219301339)) as example data (download [here](https://biobigdata.nju.edu.cn/scPlantDB/SeuratObj.rds)), you can use the R codes below to prepare gene input file:
